...
Route::middleware("auth")->group(function() {
    ...
    Route::post("/user/profile/update-data", [ProfileController::class, "updateUserData"])->name("user.profile.update-user-data");
    Route::post("/user/profile/update-address", [ProfileController::class, "updateUserAddress"])->name("user.profile.update-user-address");
